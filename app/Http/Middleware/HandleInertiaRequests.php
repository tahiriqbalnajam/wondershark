    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            'flash' => [
                ...
                'analysis_triggered' => fn () => $request->session()->get('analysis_triggered'),
            ...
            'trial' => $user ? [
                ...
                'show_paywall'           => $user->isOnTrial() && $user->trialDaysLeft() <= 4 && (int) ($user->trial_discount ?? 50) > 0 && ! $user->activeSubscription,
                ...
                'show_complimentary_popup' => $user->trial_days >= 180 && ! $user->activeSubscription,
