                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-2">
                                <Select value={brandFilter} onValueChange={(value: 'all' | 'with-agency' | 'without-agency') => setBrandFilter(value)}>
                                    <SelectTrigger className="w-48">
                                                    ...
                                                    <td className="py-3 px-4">
                                                        <div className="flex items-center gap-2">
                                                            <div className="w-8 h-8 rounded bg-gray-100 flex items-center justify-center">
                                                                <img 
                                                                    src={`https://img.logo.dev/${b.website?.replace(/^https?:\/\//, '').replace(/^www\./, '').split('/')[0]}?format=png&token=pk_AVQ085F0QcOVwbX7HOMcUA`}
                                                                    alt={b.name}
                                                    ...
                                                    <td className="py-3 px-4">
                                                        {b.has_agency ? (
                                                            <div>
                                                                ...
                                                                {b.agency_email && (
                                                                    <div className="text-xs text-gray-500">{b.agency_email}</div>
                                                                )}
                                                            </div>
                                                        ) : (
