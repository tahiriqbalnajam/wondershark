...
Route::middleware(['auth', 'verified', 'require.access'])->group(function () {
    ...
    Route::middleware('role.permission:view-admin-panel')->group(function () {
        ...
        Route::prefix('admin/analysis-monitor')->name('admin.analysis-monitor.')->middleware('role.permission:view-admin-panel')->group(function () {
            ...
            Route::post('/recalculate-all', [\App\Http\Controllers\Admin\AnalysisMonitorController::class, 'recalculateAll'])->name('recalculate-all');
            Route::post('/{brand}/analyze', [\App\Http\Controllers\Admin\AnalysisMonitorController::class, 'analyze'])->name('analyze');
            Route::post('/{brand}/recalculate', [\App\Http\Controllers\Admin\AnalysisMonitorController::class, 'recalculate'])->name('recalculate');
        });
    ...
    Route::middleware('role.permission:null,agency|brand|agency_member')->group(function () {
        ...
        Route::patch('brands/{brand}/campaign-indicator', [BrandController::class, 'updateCampaignIndicator'])->name('brands.updateCampaignIndicator');
        ...
        Route::get('brands/{brand}/competitors-visibility', [BrandController::class, 'brandCompetitorsVisibility'])->name('brands.competitors-visibility');
